...
| *Freemium* | 24 VM di storage in totale ^1,2^ 


| *PAYGO o BYOL basati sulla capacità* ^3^ | 24 VM di storage in totale ^1,2^ 
...
| *BYOL basato su nodo* ^4^ | 24 VM di storage in totale ^1,2^ 
|===
